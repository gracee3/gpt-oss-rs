...
| H6 | [real one-layer owner shell and three-owner oracle](h6/README.md) | H6a passed; twelve exact owner-shell/router/reduction/residual boundaries and resident handoffs are proven; H6b real concurrent three-owner execution remains in progress |
