...
| H6 | [real one-layer owner shell and three-owner oracle](h6/README.md) | H6a passed; v3 proves twelve exact owner-shell/router/reduction/residual boundaries, fixed owned host staging, five post-enqueue drain/retry cases, and resident handoffs; H6b real concurrent three-owner execution remains in progress |
