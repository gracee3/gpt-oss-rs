...
- The current blocker is no longer layer-1 attention entry or attention completion: on the exact `4096 + 1` retained case, the run now reaches `RETAINED_LAYER_BOUNDARY layer=1 stage=attention_done`.
