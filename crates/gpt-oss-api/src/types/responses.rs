...
impl ResponseFunctionTool {
    ...
    pub fn to_tool_definition(&self) -> gpt_oss_tokenizer::ToolDefinition {
        gpt_oss_tokenizer::ToolDefinition {
...
impl ResponseUsage {
    pub fn from_request_output(output: &gpt_oss_core::prelude::RequestOutput) -> Self {
...
mod tests {
    ...
    fn response_usage_maps_request_output() {
        let output = gpt_oss_core::prelude::RequestOutput {
            request_id: gpt_oss_core::prelude::RequestId(1),
            prompt: "Hello".into(),
            prompt_token_ids: vec![1, 2, 3],
            prompt_logprobs: None,
            outputs: vec![gpt_oss_core::prelude::CompletionOutput {
                index: 0,
                text: "world".into(),
                token_ids: vec![4, 5],
                cumulative_logprob: -1.0,
                logprobs: None,
                finish_reason: Some(gpt_oss_core::prelude::FinishReason::Stop),
            }],
            finished: true,
        };
