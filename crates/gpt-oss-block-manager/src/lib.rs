...
pub use gpt_oss_memory::DeviceType as Device;
pub use gpt_oss_sequence::SequenceStatus;

// ---------------------------------------------------------------------------
// PhysicalBlock: kept local because gpt_oss_memory::PhysicalBlock uses atomic
...
// TODO: unify with gpt_oss_memory::PhysicalBlock once APIs converge
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Sequence: uses the real gpt_oss_sequence::Sequence. The block manager accesses
// seq_id and total length via the real Sequence API.
// ---------------------------------------------------------------------------
pub use gpt_oss_sequence::Sequence;

// ---------------------------------------------------------------------------
// MemoryPool: kept local because gpt_oss_memory::MemoryPool returns
// Result<PhysicalBlock> while this trait returns Option<BlockId>.
// TODO: unify with gpt_oss_memory::MemoryPool once APIs converge
// ---------------------------------------------------------------------------
