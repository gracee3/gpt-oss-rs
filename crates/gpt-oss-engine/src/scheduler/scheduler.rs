...
use gpt_oss_core::prelude::{BlockId, RequestId, Result};
use gpt_oss_engine::block_manager::BlockManager;
use gpt_oss_engine::sequence::{Sequence, SequenceStatus};

use super::outputs::{ScheduledSequenceGroup, SchedulerOutputs};
use super::policy::{PreemptionMode, SchedulerPolicy};

// ---------------------------------------------------------------------------
// SequenceGroup: kept local because gpt_oss_engine::sequence::SequenceGroup has different
// fields (sampling_params, prompt_text) vs our priority/chunked-prefill fields.
// Uses real gpt_oss_engine::sequence::{Sequence, SequenceStatus} for inner sequences.
// TODO: unify with gpt_oss_engine::sequence::SequenceGroup once APIs converge
// ---------------------------------------------------------------------------
...
mod tests {
    ...
    use gpt_oss_engine::block_manager::MemoryPool;
    use std::sync::Arc;
