...
pub struct WorkerConfig {
    ...
    /// Original pretraining context length used for YaRN interpolation/extrapolation.
    ...
    pub rope_theta: f32,
    /// RoPE scaling type from the model config (for GPT-OSS this is `yarn`).
    ...
    /// Whether correction-range bounds are truncated when computing YaRN tables.
