use gpt_oss_core::prelude::{SequenceId, TokenId};
use serde::{Deserialize, Serialize};

use super::status::SequenceStatus;
...
impl Sequence {
    ...
    pub fn set_status(&mut self, status: SequenceStatus) -> gpt_oss_core::prelude::Result<()> {
