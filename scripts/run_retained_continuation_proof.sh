...
builtins = {
    ...
    "retained-router-loop-v1": [
        ...
        "RETAINED_MLP_STAGE layer=0 stage=first_token_loop_begin",
        "RETAINED_MLP_STAGE layer=0 stage=router_score_alloc_begin",
        "RETAINED_MLP_STAGE layer=0 stage=router_score_alloc_done",
        "RETAINED_MLP_STAGE layer=0 stage=router_score_first_accum_begin",
        "RETAINED_MLP_STAGE layer=0 stage=router_score_first_accum_done",
    ...
    "retained-router-samples-v1": [
        ...
        "RETAINED_MLP_STAGE layer=0 stage=topk_zero_guard_done",
        "RETAINED_MLP_STAGE layer=0 stage=score_loop_begin",
        "RETAINED_MLP_STAGE layer=0 stage=token_idx_0",
    ...
    "retained-layer-handoff-v1": [
        ...
        "RETAINED_MLP_STAGE layer=0 stage=aggregate_done",
        "RETAINED_PREFILL_STAGE layer=0 stage=mlp_done",
        "RETAINED_LAYER_BOUNDARY layer=0 stage=return_to_runner",
        "RETAINED_LAYER_BOUNDARY layer=1 stage=layer_begin",
        "RETAINED_LAYER_BOUNDARY layer=1 stage=attention_begin",
        "RETAINED_STEP_FORWARD_DONE",
        "DECODE1_BEGIN",
        "RETAINED_PROOF_ENTER",
        "RETAINED_PROOF_CAPTURED",
    ],
    "retained-layer1-attn-v1": [
        "RETAINED_CHILD_START",
        "RETAINED_CHILD_TOKENIZED",
        "RETAINED_CHILD_BUILD_WORKER_DONE",
        "RETAINED_STEP_BEGIN",
        ...
        "RETAINED_LAYER_BOUNDARY layer=1 stage=layer_begin",
        "RETAINED_LAYER_BOUNDARY layer=1 stage=attention_begin",
        "RETAINED_LAYER_BOUNDARY layer=1 stage=attention_done",
        "RETAINED_LAYER_BOUNDARY layer=1 stage=residual_done",
        "RETAINED_LAYER_BOUNDARY layer=1 stage=mlp_begin",
        "RETAINED_STEP_FORWARD_DONE",
        "DECODE1_BEGIN",
        "RETAINED_PROOF_ENTER",
        "RETAINED_PROOF_CAPTURED",
    ],
    "retained-layer1-postattn-v1": [
        "RETAINED_CHILD_START",
        "RETAINED_CHILD_TOKENIZED",
        "RETAINED_CHILD_BUILD_WORKER_DONE",
        "RETAINED_STEP_BEGIN",
    ...
    "retained-layer1-residual-v1": [
        ...
        "RETAINED_LAYER_BOUNDARY layer=1 stage=attention_begin",
        "RETAINED_LAYER_BOUNDARY layer=1 stage=attention_done",
        "RETAINED_LAYER_BOUNDARY layer=1 stage=postattn_residual_begin",
        "RETAINED_LAYER_BOUNDARY layer=1 stage=postattn_residual_done",
        "RETAINED_LAYER_BOUNDARY layer=1 stage=residual_done",
        "RETAINED_LAYER_BOUNDARY layer=1 stage=mlp_begin",
        "RETAINED_STEP_FORWARD_DONE",
        "DECODE1_BEGIN",
    ...
    "retained-layer1-mlp-v1": [
        ...
        "RETAINED_LAYER_BOUNDARY layer=1 stage=residual_done",
        "RETAINED_LAYER_BOUNDARY layer=1 stage=mlp_begin",
        "RETAINED_MLP_STAGE layer=1 stage=prerouter_begin",
        "RETAINED_MLP_STAGE layer=1 stage=prerouter_setup_done",
        "RETAINED_MLP_STAGE layer=1 stage=prerouter_cast_done",
        "RETAINED_MLP_STAGE layer=1 stage=router_invoke_begin",
        "RETAINED_MLP_STAGE layer=1 stage=router_call_entered",
        "RETAINED_MLP_STAGE layer=1 stage=router_dtoh_begin",
        "RETAINED_MLP_STAGE layer=1 stage=router_dtoh_done",
        "RETAINED_MLP_STAGE layer=1 stage=router_input_ready",
        "RETAINED_MLP_STAGE layer=1 stage=token_idx_1024",
        "RETAINED_MLP_STAGE layer=1 stage=token_idx_2048",
        "RETAINED_MLP_STAGE layer=1 stage=token_idx_3072",
        "RETAINED_MLP_STAGE layer=1 stage=token_idx_4095",
        "RETAINED_MLP_STAGE layer=1 stage=aggregate_done",
        "RETAINED_LAYER_BOUNDARY layer=1 stage=mlp_done",
        "RETAINED_STEP_FORWARD_DONE",
        "DECODE1_BEGIN",
        "RETAINED_PROOF_ENTER",
        "RETAINED_PROOF_CAPTURED",
    ],
    "retained-layer1-router-v1": [
        "RETAINED_CHILD_START",
        "RETAINED_CHILD_TOKENIZED",
        "RETAINED_CHILD_BUILD_WORKER_DONE",
        "RETAINED_STEP_BEGIN",
        ...
        "RETAINED_MLP_STAGE layer=1 stage=router_dtoh_done",
        "RETAINED_MLP_STAGE layer=1 stage=router_input_ready",
        "RETAINED_MLP_STAGE layer=1 stage=router_score_begin",
        "RETAINED_MLP_STAGE layer=1 stage=router_score_alloc_begin",
        "RETAINED_MLP_STAGE layer=1 stage=router_score_alloc_done",
        "RETAINED_MLP_STAGE layer=1 stage=router_score_first_accum_begin",
        "RETAINED_MLP_STAGE layer=1 stage=router_score_first_accum_done",
        "RETAINED_MLP_STAGE layer=1 stage=router_topk_begin",
        "RETAINED_MLP_STAGE layer=1 stage=router_topk_done",
        "RETAINED_MLP_STAGE layer=1 stage=first_expert_dispatch_begin",
        "RETAINED_MLP_STAGE layer=1 stage=first_expert_dispatch_done",
        "RETAINED_MLP_STAGE layer=1 stage=aggregate_done",
        "RETAINED_LAYER_BOUNDARY layer=1 stage=mlp_done",
        "RETAINED_STEP_FORWARD_DONE",
        "DECODE1_BEGIN",
